...
func TestRun(t *testing.T) {
	...
	t.Run("when_agent_returns_result_it_is_returned", func(t *testing.T) {
		ag := fakellmagent.NewWithSimpleAnswer("good")
		c := New(testConfig, ag)
		got, err := c.Run(t.Context(), defaultContent)
		if err != nil {
	...
	t.Run("when_agent_fails_error_is_returned", func(t *testing.T) {
		ag := fakellmagent.NewWithError(errors.New("agent failed"))
		c := New(testConfig, ag)
		_, err := c.Run(t.Context(), defaultContent)
