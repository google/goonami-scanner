...
func (x *GlobalConfig_Performance) GetMaxHttpRedirects() int32 {
	if x != nil {
		return x.xxx_hidden_MaxHttpRedirects
	}
	return 0
}
...
func (x *GlobalConfig_Performance) HasMaxHttpRedirects() bool {
	if x == nil {
		return false
	}
...
func (x *GlobalConfig_Performance) ClearMaxHttpRedirects() {
